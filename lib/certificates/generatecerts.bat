...
makecert -n "CN=IdentityDemoRoot" -a sha1 -r -sv IdentityDemoRoot.pvk IdentityDemoRoot.cer
...
makecert -iv IdentityDemoRoot.pvk -n "CN=identity.demo.local" -a sha1 -ic IdentityDemoRoot.cer -sky exchange -pe -sv IdentityDemoLocalSSL.pvk IdentityDemoLocalSSL.cer
